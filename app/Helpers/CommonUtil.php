...
class CommonUtil
{
    ...
    const SECRET = 'muziuijUkenOESturU6B6uvyFuWuWlQYd9RA3SCFi2HTT4TCAOplVQxvFHfHkU8R';
    const KEY = 'Mno57wzUPEsJrPrzGQdyXmvoXJQSojzmjusdDziaGVi=';
    ...
    public static function sendSms($noTelp, $textSms = "default", $desc = "Test")
    {
        // Send sms gateway
